...
model_g960 = pickle.load(open('Regresi_G960_21 Jan 2026.sav', 'rb'))
...
with container1:
    ...
    st.title('Prediksi harga penawaran Tepung Coklat G-960')

    bursa = st.number_input("Masukkan harga bursa Cocoa")


    if st.button('Predict harga penawaran Tepung Coklat G-960'):
        prediksi_harga_penawaran = model_g960.predict(([[bursa]]))                          
